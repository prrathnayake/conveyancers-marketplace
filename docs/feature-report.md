...
| Communication & Document Exchange | Secure Messaging | Partial | Job transcripts are exposed via `/jobs/{id}/chat`, but the messages are static snapshots and lack WebSocket delivery or encryption guarantees.【F:backend/services/jobs/main.cpp†L23-L307】 |
| Communication & Document Exchange | File Upload & Scanning | Missing | Job documents list pre-generated signed URLs, but no upload endpoints, antivirus invocation, or storage adapters are implemented.【F:backend/services/jobs/main.cpp†L30-L195】 |
...
| Security & Compliance | Data Security | Missing | There is no evidence of TLS configuration within services or encryption-at-rest utilities beyond README aspirations.【F:backend/services/payments/main.cpp†L179-L293】 |
